...
namespace DTO_LAYER
{
    public class DTO_HANGHOA
    {
        ...
        /* === Constructor === */
        public DTO_HANGHOA(int maHang, string tenHang, int soLuong, float donGiaNhap, float donGiaBan, string hinhAnh, string ghiChu)
        {
        ...
        public DTO_HANGHOA(string tenHang, int soLuong, float donGiaNhap, float donGiaBan, string hinhAnh, string ghiChu, string emailNv)
        {
            this.SP_TenHang = tenHang;
            this.SP_SoLuong = soLuong;
            this.SP_DonGiaNhap = donGiaNhap;
